...
void publishMessage(const char* topic, String payload , boolean retained) {
  if (client.publish(topic, payload.c_str(), retained)) // Hier 'retained' korrekt verwenden
      Serial.println("Nachricht veröffentlicht [" + String(topic) + "]: " + payload);
}
